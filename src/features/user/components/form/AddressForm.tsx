...
import type { UserAddress } from "@/services/user/type";
import type { ApiQuery } from "@/services/type";
import { HttpStatus } from "@/services/axios";
import { useRule } from "@/hooks";
import ConfirmModal from "@/components/Page/ConfirmModal";
import useLocationStore from "@/store/LocationStore";
import useGetDistricts from "@/components/Page/AppMain/AppData/hooks/useGetDistricts";
import useGetWards from "@/components/Page/AppMain/AppData/hooks/useGetWards";
...
const AddressForm: FC<AddressFormProps> = ({ lang, isUpdate, address, onReFetch, handleShowAddress }) => {
  ...
  const handleRemoveAddress = () => {
    const apiQuery: ApiQuery = { userId: address?.userId };
